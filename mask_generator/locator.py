...
def face_points(img, add_boundary_points=True):
  ...
  # leon change: I am passing the images sraight from the other script.
  # to run the stasm command on it, I save it ins a temporary file
  cv2.imwrite("temp.jpg", img)
  command = [stasm_path, '-f', data_folder, "temp.jpg"]
